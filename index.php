...
<head>
    ...
    <link rel="shortcut icon" href="img/siteicon.png?v=<?= @filemtime('img/siteicon.png') ?>" id="site-favicon" />
    <title>Karabey - Güvenilir Sponsor Bahis Siteleri</title>
    <meta name="robots" content="max-image-preview:large"/>
    <meta name="description" content="Karabey - Güvenilir bahis siteleri ve sponsorlar"/>
...
<body>
    ...
    <div class="page-loader" id="pageLoader">
        <div class="loader-content">
            <div class="loader-neon-text">Kara<span>bey</span></div>
            <div class="loader-subtitle">Luxury Casino</div>
        ...
        <div class="container">
            <div class="header-inner">
                <a href="/" class="header-brand">
                    <img src="img/logo.png?v=<?= @filemtime('img/logo.png') ?>" alt="Karabey" class="header-logo-img" />
                </a>
    ...
    <section class="logo-marquee-section">
        <div class="logo-marquee-wrapper">
            <div class="logo-marquee-track">
                <?php
                // Kesintisiz kayma için siteleri tekrarla
                $all_sites = array_values($sites);
                $repeated_sites = array_merge($all_sites, $all_sites);
                foreach ($repeated_sites as $site):
                ?>
                <a href="<?= htmlspecialchars($site['link']) ?>" target="_blank" class="logo-marquee-item">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-brand">
                    <img src="img/logo.png?v=<?= @filemtime('img/logo.png') ?>" alt="Karabey" />
                    <p>Tüm güvenilir bahis sitelerinin tek adresi Karabey Casino</p>
                </div>


            </div>
            <div class="footer-bottom">
                <p>Copyright &copy; <?= date('Y') ?> Karabey</p>
            </div>
        </div>
    </footer>
