<?php
// Session ve kullanıcı işlemleri
...
<body>
        ...
        <div class="container">
            <div class="header-inner">
                ...
                <div class="header-auth">
                    <button class="auth-btn auth-btn-login" id="loginBtn">
                        <i class="fas fa-sign-in-alt"></i>
                        <span>Giriş Yap</span>
                    </button>
                    <button class="auth-btn auth-btn-register" id="registerBtn">
    ...
    <div class="auth-modal-overlay" id="authModal">
        <div class="auth-modal">
            <div class="auth-modal-header">
                ...
                <h2 class="auth-modal-title">Harley Casino</h2>
                <p class="auth-modal-subtitle">Topluluğumuza katılın ve puan kazanın!</p>
            </div>

            <div class="auth-tabs">
                <button class="auth-tab active" data-tab="login">Giriş Yap</button>
                <button class="auth-tab" data-tab="register">Üye Ol</button>
            </div>
            ...
            <div class="auth-modal-body">
                ...
                <form class="auth-form active" id="loginForm" data-tab="login">
                    <div class="form-group">
                        ...
                        <div class="form-input-wrapper">
                            <input type="text" class="form-input" name="username" placeholder="Kullanıcı adı veya e-posta" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-wrapper">
                            <input type="password" class="form-input" name="password" placeholder="Şifreniz" required>
                ...
                <form class="auth-form" id="registerForm" data-tab="register">
                    <div class="form-group">
                        ...
                        <div class="form-input-wrapper">
                            <input type="text" class="form-input" name="username" placeholder="Kullanıcı adınız" required minlength="3" maxlength="20">
                            <i class="fas fa-user form-input-icon"></i>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="form-label">Şifre</label>
                        <div class="form-input-wrapper">
                            <input type="password" class="form-input" name="password" placeholder="En az 6 karakter" required minlength="6">
                            <i class="fas fa-lock form-input-icon"></i>
                            <button type="button" class="password-toggle">
                                <i class="fas fa-eye"></i>
                            </button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-wrapper">
                            <input type="password" class="form-input" name="password_confirm" placeholder="Şifrenizi tekrar girin" required>
                            <i class="fas fa-lock form-input-icon"></i>
                        </div>
                    </div>
                    <button type="submit" class="auth-submit-btn">
                    ...
                    <p class="auth-terms">
                        Üye olarak <a href="#">Kullanım Şartları</a>'nı ve <a href="#">Gizlilik Politikası</a>'nı kabul etmiş olursunuz.
                    </p>
                </form>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (registerBtnHeader) {
            registerBtnHeader.addEventListener('click', () => openAuthModal('register'));
        }
        if (authModalClose) {
