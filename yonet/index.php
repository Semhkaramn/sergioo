                            ...
                            <div class="card-body">
                                <form id="popupForm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off" name="popup_number" id="popupNumber">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Popup Başlık 2</label>
                                        <input type="text" class="form-control" autocomplete="off" name="popup_title" id="popupTitle">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Popup Alt Başlığı</label>
                                        <input type="text" class="form-control" autocomplete="off" name="popup_subtitle" id="popupSubtitle">
                                    </div>
